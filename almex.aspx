<%@ Page Language="C#" AutoEventWireup="true" CodeFile="almex.aspx.cs" Inherits="almex_almex" %>
                ...
                <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                        <ul class="kt-menu__nav ">
                            <li class="kt-menu__item <%if (pageType == "dash") { Response.Write("kt-menu__item--active"); } %>" aria-haspopup="true"><a href="../Default.aspx?actn=dash" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-home"></i><span class="kt-menu__link-text">Dashboard</span></a></li>
                            <% if (sessionType == "5")
                                { %>
                            ...
                            <li class="kt-menu__item <%if (pageType == "minvalmx") { Response.Write("kt-menu__item--active"); } %>" aria-haspopup="true"><a href="almex/almex.aspx" class="kt-menu__link "><i class="kt-menu__link-icon fa fa-file-invoice"></i><span class="kt-menu__link-text">Generar guía Almex</span></a></li>
                            <% }%>
                            <% if (sessionType == "5")
                                { %>
                            ...
                            <li class="kt-menu__item <%if (pageType == "minv") { Response.Write("kt-menu__item--active"); } %>" aria-haspopup="true">
                                <a href="../Default.aspx" class="" style="text-align: center">
