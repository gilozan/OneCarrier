...
public partial class Comprobante
{
    ...
    public string QR
    {
        get
        {
            ...
            qr = Bnet.Suite.Documents.QR.createBarCode("https://verificacfdi.facturaelectronica.sat.gob.mx/default.aspx?id=" + TimbreFiscalDigital.UUID +
    ...
    public string MonedaConLetra
    {
        get
        {
            Bnet.Suite.Documents.Moneda oMoneda = new Bnet.Suite.Documents.Moneda();
